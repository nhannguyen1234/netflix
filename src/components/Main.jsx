    ...
    return (
        <div className="w-full h-[800px] text-white">
            <div className="w-full h-full">
                <div className="absolute h-[800px] w-full bg-gradient-to-t from-black"></div>
                <img
            ...
            <div className="absolute w-full top-[25%] p-4 md:p-8">
                <h1 className="text-3xl md:text-5xl font-bold mb-4 select-none">{movie?.title}</h1>
                ...
                <p className="w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w-[35%] text-gray-200 select-none">
